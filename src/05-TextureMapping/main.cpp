...
class HelloTriangleApplication {
    ...
    private:
        ...
        void createGraphicsPipeline() {
            auto vertShaderCode = readFile("../src/05-TextureMapping/shaders/vert.spv");
            auto fragShaderCode = readFile("../src/05-TextureMapping/shaders/frag.spv");
        ...
        void createTextureImage() {
            ...
            stbi_uc* pixels = stbi_load("../src/05-TextureMapping/textures/texture.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
